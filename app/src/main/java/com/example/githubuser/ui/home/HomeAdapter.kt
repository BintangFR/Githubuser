...
class HomeAdapter(private val context: Context) : ListAdapter<UserData, HomeAdapter.ViewHolder>(DiffCallback()) {
    ...
    inner class ViewHolder(private val binding: ItemUserBinding, private val context: Context) :
        ...
        fun bind(userData: UserData, userInterface: UserInterface?){
            ...
            binding.apply {
                ...
                textViewLocationCompany.text = String.format("%s, %s", userData.location?: context.getString(
                    R.string.No_Location), userData.company?: context.getString(R.string.No_Company))
                textViewFollowerFollowing.text = String.format(context.getString(R.string.Followers_and_Following),userData.followers, userData.following)
